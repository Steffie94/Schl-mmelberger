...
//Infinit Generator wurde nicht mehr benötigt da wir den Terrain Generator nicht im Spiel verwendet haben
...
public class InfiniteGenerate : MonoBehaviour
{
    ...
    int planeSize = 10;//Wie groß es werden soll
    int halfTilesX = 5;//Radiuswert
    int halfTilesZ = 5;//Radiuswert

    Vector3 startPos;
    
    //Verwaltet die Kacheln
    ...
    void Start()
    {
        ...
        //Schleife durchläuft meine Radiuswerte und ordent meine Kacheln an 
